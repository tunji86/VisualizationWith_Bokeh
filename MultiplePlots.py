...
class Plot:
    ...
    def plots(self,data,x,y,z):
        ...
        #customize hover
        self.hover.tooltips=[('x Value','@x{%F}'),('y Value','@y'),('z Value','@z')]
        ...
        self.f.line(x_axis,z_axis,alpha=0.5,color='blue')
...
plot=Plot()
plot.plots("Data.xlsx",'Date','Close/Last','Open')
#plot.otherStuff()
